...
for shot_num in range(3):
    if __name__ == '__main__':
        ...
        parser.add_argument('--train_shot', type=int, default=8)
        parser.add_argument('--test_shot', type=int, default=8)
        ...
        parser.add_argument('--n_task',default=2000)

        args = parser.parse_args()
    save_path='./looregression/oursloo_task'+str(args.n_task)+'_shot'+str(args.train_shot)+'_'+str(shot_num)
    pprint(vars(args))
    ...
    for epoch in range(1, args.max_epoch + 1):
        ...
        #model.load_state_dict(torch.load('./regression/shot5_d40_tsstep10_trstep5/max-loss.pth'))
