...
if __name__ == '__main__':
    ...
    if params.method == 'baseline':
        ...
        model           = Ours( model_dict[params.model], **few_shot_params )
    ...
    if params.method in ['maml', 'maml_approx','Ours']: #maml do not support testing with feature
        ...
        #loss=model.test_loop( novel_loader, return_std = True)

    else:
        novel_file = '.'+os.path.join( checkpoint_dir.replace("checkpoints","features"), split_str +".hdf5")
        #novel_file = '.' + os.path.join(checkpoint_dir, split_str + ".hdf5")
